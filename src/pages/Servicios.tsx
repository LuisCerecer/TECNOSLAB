                ...
                <div>
                  <div className="mb-6">
                    ...
                    <p className="text-gray-700 mb-6 text-lg leading-relaxed">
                      Medición precisa con el equipo F Speed Reader de CoGri Group para determinar el cumplimiento con estándares internacionales 
                    </p>
          ...
          <div ref={disenoIngenieriaRef} id="diseno-ingenieria" className="mb-20">
            ...
            <div className="bg-white p-8 shadow-xl rounded-xl">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div className="flex justify-center">
                  <img 
                    src="https://res.cloudinary.com/dy089iwsg/image/upload/v1752716406/Inge_ak87fs.jpg" 
          ...
          <div ref={correccionRecubrimientosRef} id="correccion-recubrimientos" className="mb-20">
            ...
            <div className="bg-white p-8 shadow-xl rounded-xl">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                ...
                <div className="flex justify-center">
                  <img 
                    src="https://res.cloudinary.com/dy089iwsg/image/upload/v1752716410/Recu_mjyves.jpg" 
